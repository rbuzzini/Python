...
# for loop to print values in a specific cell range:
value_range = sh1['A1':'H5']

for a, b, c, d, e, f, g, h in value_range:
    print(a.value, b.value, c.value, d.value, e.value, f.value, g.value, h.value)
